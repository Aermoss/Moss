...
def setMeshAlbedoMap(environ):
    try:
        ...
        mesh.parts[environ["args"]["material"]]["textures"]["albedoMap"] = moss.Texture(mesh.shader, environ["args"]["albedoMap"], 0)
...
def setMeshRoughnessMap(environ):
    try:
        mesh = environ["context"].api["objects"][environ["args"]["id"]].meshes[environ["args"]["mesh"]]
        mesh.parts[environ["args"]["material"]]["textures"]["roughnessMap"] = moss.Texture(mesh.shader, environ["args"]["roughnessMap"], 1)
...
def setMeshMetallicMap(environ):
    try:
        mesh = environ["context"].api["objects"][environ["args"]["id"]].meshes[environ["args"]["mesh"]]
        mesh.parts[environ["args"]["material"]]["textures"]["metallicMap"] = moss.Texture(mesh.shader, environ["args"]["metallicMap"], 2)
...
def setMeshNormalMap(environ):
    try:
        mesh = environ["context"].api["objects"][environ["args"]["id"]].meshes[environ["args"]["mesh"]]
        mesh.parts[environ["args"]["material"]]["textures"]["normalMap"] = moss.Texture(mesh.shader, environ["args"]["normalMap"], 3)
...
def setMeshSpecularMap(environ):
    try:
        mesh = environ["context"].api["objects"][environ["args"]["id"]].meshes[environ["args"]["mesh"]]
        mesh.parts[environ["args"]["material"]]["textures"]["specularMap"] = moss.Texture(mesh.shader, environ["args"]["specularMap"], 4)
...
def setMeshAmbientMap(environ):
    try:
        mesh = environ["context"].api["objects"][environ["args"]["id"]].meshes[environ["args"]["mesh"]]
        mesh.parts[environ["args"]["material"]]["textures"]["ambientMap"] = moss.Texture(mesh.shader, environ["args"]["ambientMap"], 5)
